  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-background/80 backdrop-blur-md border-b border-purple-800/20"
          : "bg-transparent"
      )}
    >
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="hover:bg-purple-800/10 hover:text-purple-500"
              >
            ...
            <SheetContent
              side="right"
              className="border-purple-800/20 backdrop-blur-md"
            >
